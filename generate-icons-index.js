...
// Header to prepend to the generated file.
...
export function generateIconsIndex(options = {}) {
    ...
    const currentContent = fs.existsSync(OUTPUT_FILE) ? fs.readFileSync(OUTPUT_FILE, "utf8") : null;
    ...
    if (
        ...
        if (!quiet) {
            console.log(`= Icon exports already up to date (${files.length} icons).`);
        }
    ...
    fs.writeFileSync(OUTPUT_FILE, nextContent);
