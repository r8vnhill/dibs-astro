...
// Published-package resolution test
// This import proves that the root app can consume the registry-backed content-core artifact.
// If this import fails, the published dependency or its root API is not correctly wired.
...
if (process.env.DEBUG_WORKSPACE) {
    console.log(`Published package validation: ${CONTENT_CORE_PACKAGE_NAME} v${CONTENT_CORE_VERSION}`);
}
