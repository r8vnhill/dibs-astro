 ...
 * - specialized language wrappers such as `PythonLink`, `NushellLink`, `BashLink`, and
 *   `FishLink`, which only bind naming, iconography, and trailing-slash route resolution for a
