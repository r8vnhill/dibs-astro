 ...
 *
 * Notes:
 * - The DIBS adapter supplies the complete navigation model.
 * - This component only handles UI state; navigation content lives in `./nav-items`.
 */
...
export default function HeaderNav({ items }: HeaderNavProps): JSX.Element {
    ...
    return (
        <>
            ...
            <MobileNavList isOpen={isOpen} items={items} onItemSelect={close} />
        </>
    );
}
