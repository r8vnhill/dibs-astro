...
- It owns route normalization, export route derivation, PDF output-path derivation, manifest filtering, and manifest
  validation.
...
- Keep rendering, browser automation, route generation, and filesystem side effects in the consuming application.
